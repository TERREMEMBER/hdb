...
class GpInitSystemTest(GpTestCase):
    ...
    def test_option_cluster_configfile_and_input_configfile_should_error(self):
        ...
        self.assertNotIn("Creates a new inHybrid Database instance", output)
        self.assertNotIn("Initializes a inHybrid Database system by using configuration", output)
    ...
    def test_option_help_prints_docs_usage(self):
        ...
        output = p.stdout.read()
        self.assertIn("Initializes a inHybrid Database system by using configuration", output)
        self.assertNotIn("Creates a new inHybrid Database instance", output)
    ...
    def test_invalid_option_prints_raw_usage(self):
        ...
        self.assertIn("Creates a new inHybrid Database instance", output)
        self.assertNotIn("Initializes a inHybrid Database system by using configuration", output)
