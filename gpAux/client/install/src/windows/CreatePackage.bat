...
copy ..\..\..\..\..\gpMgmt\bin\hdbload.py %GPDB_INSTALL_PATH%\bin
...
perl -pi.bak -e "s,\$Revision\$,%VERSION%," %GPDB_INSTALL_PATH%\bin\hdbload.py
copy ..\..\..\..\..\gpMgmt\bin\hdbload.bat %GPDB_INSTALL_PATH%\bin
